...
const SECTIONS = [
  ...
  {
    title: "広告配信について",
    body: "当サイトでは、第三者配信の広告サービス「Google AdSense」を利用しています。広告配信事業者は、ユーザーの興味に応じた広告を表示するためにCookieを使用することがあります。Cookieを無効にする方法や、広告に関するCookieの詳細については「広告設定」やGoogleの「広告に関するポリシー」ページをご確認ください。",
  },
  {
